...
const SignUp = ({ onGetStartedClick }) => {
  ...
  }, [isError, isLoading, isSuccess, navigate, data]);
  ...
  return (
    <div className={`signUpPage ${styles.signUpDiv}`}>
      <div className={`container ${styles.centeredCard}`}>
        <div className="row">
          <div className="card text-white mb-3" style={{ width: "100%", backgroundColor: "#202020" }}>
            <div className={`card-body text-white ${styles.SignUpForm}`}>
              <Lottie className="flex-end" animationData={animationData} style={{ height: "150px" }} />
              <h1 className={`card-title text-center ${styles.h1}`} style={{ fontSize: "40px" }}>
                SonaAI
              </h1>
              <p className="card-subtitle mb-2 text-center" style={{ fontFamily: "Sedan, serif", fontSize: "11px", fontWeight: "100", color: "#999999" }}>
                Please Sign Up To A New Account{" "}
              </p>
              <form className={`${styles.form}`}>
                <div className="mb-3">
                  <div className={`mb-3 ${styles.inputContainer}`}>
                    <img src={nameIcon} alt="icon" className={`icon ${styles.icon}`} />
                    <input
                      type="text"
                      className={`form-control ${styles.input}`}
                      id="exampleInputName1"
                      placeholder="First Name"
                      style={{ width: "100%", height: "45px", borderRadius: "15px", border: "#333333" }}
                    />
                  </div>
                  <div className={`mb-3 ${styles.inputContainer}`}>
                    <img src={nameIcon} alt="icon" className={`icon ${styles.icon}`} />
                  ...
                  <div className={`${styles.inputContainer}`}>
                    <img src={emailIcon} alt="icon" className={`icon ${styles.icon}`} />
                    <input
                      type="email"
                      className={`form-control ${styles.input}`}
                ...
                <Link to={"/new-chat"}>
                  <button
                    ...
                    style={{ width: "100%", height: "45px", borderRadius: "15px", backgroundColor: "#d71e1f", border: "#333333" }}
                ...
                <div>
                  ...
                  <GoogleLogin onSuccess={loginSuccess} width={"300px"} height={"100px"} onFailure={loginFailure} />
                </div>
                <div>
